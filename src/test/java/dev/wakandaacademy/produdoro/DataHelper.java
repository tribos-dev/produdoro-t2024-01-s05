...
public class DataHelper {
	...
	public static EditaTarefaRequest alteraTarefa() {
		EditaTarefaRequest requestEditada = EditaTarefaRequest.builder()
				.descricao("Tarefa alterada").build();
		return requestEditada;
	}
}